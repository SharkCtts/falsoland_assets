...
summon vex ~ ~-1 ~ {Silent:1b,Invulnerable:1b,Tags:["chainreaction_temp","no_ench_target"],PersistenceRequired:1b,NoAI:1b,Health:1f,HandItems:[{},{}],ArmorItems:[{},{},{},{id:"minecraft:polished_blackstone_button",count:1,components:{"minecraft:custom_data":{},"minecraft:enchantments":{levels:{"ench_plus:status/chainreaction":1}}}}],active_effects:[{duration:100,show_icon:0b,hidden_effect:{id:"minecraft:invisibility",duration:-1,show_icon:0b,amplifier:-2b,show_particles:0b},amplifier:-1b,id:"minecraft:invisibility",show_particles:0b}]}
