function ench_craft:setup/load
function arcade:root_setup
...
scoreboard objectives add ench_chainreac_channel dummy
...
scoreboard objectives add ench_burstmode_cooldown dummy
...
execute unless data storage lib:enchplus_disable version.1 run data merge storage lib:enchplus_disable {list: {eyes_up_guardian: 0, final_death: 0, golden_thief: 0, gunpowder: 0, radiant: 0, soul_steal: 0, ambush: 0, anger_mode: 0, banshee_was_here: 0, breakfast: 0, chain_reaction: 0, fire_aspect: 0, infection: 0, perfect_parry: 0, soul_breaker: 0, sweep: 0, void_attack: 0, weak_point: 0, burst_mode: 0, clear_sky: 0, command: 0, damage_fracture: 0, infinity: 0, peircing: 0, power: 0, quick_charge: 0, quiver_overload: 0, ricochet: 0, shulker_boo: 0, slime_hit: 0, efficiency: 0, fortune: 0, jackpot: 0, magma_hit: 0, silk_touch: 0}, held: {copper: 0, leather: 0, copper: 0, breeze: 0, gold: 0, blaze: 0, netherite: 0}, version: {1: true}}
