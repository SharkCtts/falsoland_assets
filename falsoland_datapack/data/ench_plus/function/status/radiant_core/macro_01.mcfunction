...
summon bee ~ ~1 ~ {Silent:1b,CannotEnterHiveTicks:24000,AngerTime:24000,Tags:["radiant_heal_temp"],Passengers:[{id:"minecraft:snowball",Item:{id:"minecraft:music_disc_13",count:1,components:{"minecraft:item_model": "minecraft:enchplus_entities/radiant_core"}}}],ArmorItems:[{},{},{},{id:"minecraft:polished_blackstone_button",count:1,components:{"minecraft:enchantments":{levels:{"ench_plus:status/radiant_heal":1}}}}],active_effects:[{duration:160,show_icon:0b,hidden_effect:{id:"minecraft:invisibility",duration:-1,show_icon:0b,amplifier:-2b,show_particles:0b},amplifier:-1b,id:"minecraft:invisibility",show_particles:0b}],attributes:[{id:"minecraft:attack_damage",base:-500}]}
