...
summon vex ~ ~ ~ {Silent:1b,Invulnerable:1b,PortalCooldown:199999980,PersistenceRequired:1b,NoAI:1b,Health:1f,Tags:["hungerofthevoid_temp","no_ench_target"],equipment:{head:{id:"minecraft:polished_blackstone_button",count:1,components:{"minecraft:custom_data":{},"minecraft:enchantments":{"ench_plus:status/hunger_of_the_void":1}}}},active_effects:[{id:"minecraft:invisibility",hidden_effect:{id:"minecraft:invisibility",duration:-1,show_icon:0b,amplifier:-2b,show_particles:0b},amplifier:-1,duration:100,show_particles:0b,show_icon:0b}]}
