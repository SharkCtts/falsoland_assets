...
summon bee ~ ~ ~ {Silent:1b,Invulnerable:1b,PortalCooldown:199999980,CannotEnterHiveTicks:24000,AngerTime:24000,Tags:["weak_base_1_temp"],equipment:{head:{id:"minecraft:polished_blackstone_button",count:1,components:{"minecraft:enchantments":{"ench_plus:status/weak_point":1}}}},active_effects:[{id:"minecraft:invisibility",amplifier:-1,duration:100,show_particles:0b,show_icon:0b,hidden_effect:{id:"minecraft:invisibility",duration:-1,show_icon:0b,amplifier:-2b,show_particles:0b}}],attributes:[{id:"minecraft:attack_damage",base:-500},{id:"minecraft:scale",base:0.01}]}
