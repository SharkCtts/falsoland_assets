...
summon bee ~ ~ ~ {PortalCooldown:199999999980,Invulnerable:1b,Silent:1b,CannotEnterHiveTicks:24000,AngerTime:24000,Tags:["weak_base_1_temp"],ArmorItems:[{},{},{},{id:"minecraft:polished_blackstone_button",count:1,components:{"minecraft:enchantments":{levels:{"ench_plus:status/weak_point":1}}}}],active_effects:[{duration:300,show_icon:0b,amplifier:-1b,id:"minecraft:invisibility",show_particles:0b,hidden_effect:{id:"minecraft:invisibility",duration:-1,show_icon:0b,amplifier:-2b,show_particles:0b}}],attributes:[{id:"minecraft:attack_damage",base:-500},{id:"minecraft:scale",base:0.01}]}
